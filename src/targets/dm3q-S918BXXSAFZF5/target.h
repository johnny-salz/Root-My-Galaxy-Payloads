...
#define BUILD_VARIANT_LABEL "dm3q-S918BXXSAFZF5-app-closed-route"
#define APP_PHYS_P0_ORACLE 1
#define APP_TRACEFS_SLIDE 1
#define APP_CLOSED_FOPS_ROUTE 1
#define APP_FOPS_BEFORE_PIPE 1
#define APP_MM_EARLY_DRAIN_TRIGGERS 16
#define APP_CLOSED_SLABINFO_TOUCH 1
#define APP_CLOSED_RECLAIM_QUIET 1
